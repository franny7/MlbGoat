...
const Hitters = () => {
  return (
    <div className='players'>
      ...
      <div className='player-card hitter-1'></div>
      <div className='player-card hitter-2'></div>
      <div className='player-card hitter-3'></div>
      <div className='player-card hitter-4'></div>
      <div className='player-card hitter-5'></div>
      <div className='player-card hitter-6'></div>
